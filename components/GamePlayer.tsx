...
const GamePlayer = ({ game, onBack, onToggleFavorite, isFavorite }) => {
  ...
  const toggleFullScreen = () => {
    // Cast iframe to any to avoid TypeScript errors with vendor-prefixed fullscreen methods
    const iframe = document.getElementById('game-frame') as any;
    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="glass-effect p-8 rounded-3xl">
        ...
        <div className="flex flex-wrap gap-2">
          {['Unblocked', game.category, 'Multiplayer', 'Web', 'Nexus'].map(tag => (
